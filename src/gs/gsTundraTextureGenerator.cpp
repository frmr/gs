...
const std::vector<gs::Vec3d> gs::TundraTextureGenerator::colors = { gs::Vec3d(65.0f, 80.0f, 56.0f),
																	gs::Vec3d(99.0f, 95.0f, 70.0f),
																	gs::Vec3d(80.0f, 83.0f, 72.0f),
																	gs::Vec3d(210.0f, 210.0f, 210.0f),
																	gs::Vec3d(250.0f, 250.0f, 250.0f) };

const std::vector<float> gs::TundraTextureGenerator::limits = { 0.3f, 0.5f, 0.7f, 0.8f };

gs::Color gs::TundraTextureGenerator::Sample(const gs::Vec3d& coord, const gs::LandTile::Terrain terrain)
{
...
gs::TundraTextureGenerator::TundraTextureGenerator()
	: noiseA(0), noiseB(0)
{
